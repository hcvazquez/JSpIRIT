...
public class DataBaseManager{
	...
	private DataBaseManager() {
			...
			session.createSQLQuery("DROP TABLE MODIFIABILITYSCENARIOSCRITERIA").executeUpdate();
			
			session.createSQLQuery("DROP TABLE CLASSES").executeUpdate();
			session.createSQLQuery("DROP TABLE PACKAGES").executeUpdate();
	
			
			session.createSQLQuery("DROP TABLE SCENARIO").executeUpdate();
	...
	public void saveOrUpdateEntity(Object objecToSave){
		...
		session.createSQLQuery("DROP TABLE PROBLEMS_CRITERIAIMPORTANCE").executeUpdate();
		
		session.createSQLQuery("DROP TABLE CONCERNCRITERIAIMPORTANCE").executeUpdate();
		session.createSQLQuery("DROP TABLE ARCHITECTURALCONCERNCRITERIA").executeUpdate();*/
	...
	public TraditionBreakerDetectionConfiguration getTraditionBreakerDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<TraditionBreakerDetectionConfiguration> list = session.createCriteria(TraditionBreakerDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
	...
	public ShotgunSurgeryDetectionConfiguration getShotgunSurgeryDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ShotgunSurgeryDetectionConfiguration> list = session.createCriteria(ShotgunSurgeryDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public RefusedParentBequestDetectionConfiguration getRefusedParentBequestDetectionConfiguration(String projectName){
	...
	public IntensiveCouplingDetectionConfiguration getIntensiveCouplingDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<IntensiveCouplingDetectionConfiguration> list = session.createCriteria(IntensiveCouplingDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public GodClassDetectionConfiguration getGodClassDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<GodClassDetectionConfiguration> list = session.createCriteria(GodClassDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public FeatureEnvyDetectionConfiguration getFeatureEnvyDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<FeatureEnvyDetectionConfiguration> list = session.createCriteria(FeatureEnvyDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setATFD_Greater_Few(list.get(0).getATFD_Greater_Few());
	...
	public DispersedCouplingDetectionConfiguration getDispersedCouplingDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<DispersedCouplingDetectionConfiguration> list = session.createCriteria(DispersedCouplingDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public DataClassDetectionConfiguration getDataClassDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<DataClassDetectionConfiguration> list = session.createCriteria(DataClassDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public BrainMethodDetectionConfiguration getBrainMethodDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<BrainMethodDetectionConfiguration> list = session.createCriteria(BrainMethodDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public BrainClassDetectionConfiguration getBrainClassDetectionConfiguration(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<BrainClassDetectionConfiguration> list = session.createCriteria(BrainClassDetectionConfiguration.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	/**Return the SmellRelevanceCriteria for the project name. If none instance is found in the db, it returns a new instance
	 * 
	 * @param projectName
	 * @return
	 */
	public AgglomerationConfigurationForProject getAgglomerationConfigurationForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<AgglomerationConfigurationForProject> list = session.createCriteria(AgglomerationConfigurationForProject.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	/**Return the HistoryBetaCriteria for the project name. If none instance is found in the db, it returns a new instance
	 * 
	 * @param projectName
	 * @return
	 */
	public HistoryBetaCriteria getHistoryBetaCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<HistoryBetaCriteria> list = session.createCriteria(HistoryBetaCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public HistoryLENOMCriteria getHistoryLENOMCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<HistoryLENOMCriteria> list = session.createCriteria(HistoryLENOMCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public HistoryENOMCriteria getHistoryENOMCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<HistoryENOMCriteria> list = session.createCriteria(HistoryENOMCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public AlphaCriteria getAlphaCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<AlphaCriteria> list = session.createCriteria(AlphaCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	/**Return the ModifiabilityScenariosCriteria for the project name. If none instance is found in the db, it returns a new instance
	 * 
	 * @param projectName
	 * @return
	 */
	public ModifiabilityScenariosCriteria getModifiabilityScenariosCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ModifiabilityScenariosCriteria> list = session.createCriteria(ModifiabilityScenariosCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public NOMHistoryProject getNOMHistoryProjectForProject(String projectName){
		...
		ret.setProjectName(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<NOMHistoryProject> list = session.createCriteria(NOMHistoryProject.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setProjectName(projectName);
	...
	public ArchitecturalConcernCriteria getArchitecturalProblemCriteriaForProject(
			String projectName) {
		ArchitecturalConcernCriteria ret=new ArchitecturalConcernCriteria(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ArchitecturalConcernCriteria> list = session.createCriteria(ArchitecturalConcernCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setProjectName(projectName);
	...
	public List<ArchitecturalConcern> getArchitecturalConcernsForProject(
			String projectName) {
		ArchitecturalConcern ret=new ArchitecturalConcern();
		ret.setProjectName(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ArchitecturalConcern> list = session.createCriteria(ArchitecturalConcern.class).add( Restrictions.eq("projectName", projectName) ).list();
		session.close();
		return list;
	}
	
	public List<ComponentOfBlueprint> getComponentsOfBlueprintForProject(
			String projectName) {
		ComponentOfBlueprint ret=new ComponentOfBlueprint();
		ret.setProjectName(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ComponentOfBlueprint> list = session.createCriteria(ComponentOfBlueprint.class).add( Restrictions.eq("projectName", projectName) ).list();
		session.close();
		return list;
	}
	
	
	public List<ComponentOfBlueprint> getComponentOfBlueprintForProject(
			String projectName) {
		ComponentOfBlueprint ret=new ComponentOfBlueprint();
		ret.setProjectName(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public List<ModifiabilityScenario> getModifiabilityScenariosForProject(
			String projectName) {
		ModifiabilityScenario ret=new ModifiabilityScenario();
		ret.setProjectName(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ModifiabilityScenario> list = session.createCriteria(ModifiabilityScenario.class).add( Restrictions.eq("projectName", projectName) ).list();
		session.close();
		return list;
	}
	...
	public ArchitecturalConcernCriteriaWithImportance getArchitecturalProblemCriteriaWithImportanceForProject(
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ArchitecturalConcernCriteriaWithImportance> list = session.createCriteria(ArchitecturalConcernCriteriaWithImportance.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setProjectName(projectName);
	...
	public ModifiabilityScenariosForAgglomerationCriteria getModifiabilityScenariosForAgglomerationCriteriaForProject(
			String projectName) {
		ModifiabilityScenariosForAgglomerationCriteria ret=new ModifiabilityScenariosForAgglomerationCriteria(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ModifiabilityScenariosForAgglomerationCriteria> list = session.createCriteria(ModifiabilityScenariosForAgglomerationCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setProjectName(projectName);
	...
	/*public void deleteHistoryBetaCriteria(HistoryBetaCriteria type){
		...
		try {
			transaction = session.beginTransaction();
			HistoryBetaCriteria criteria = (HistoryBetaCriteria) session.get(HistoryBetaCriteria.class, type.getId());
			for (Iterator<NOMHistoryOfAVersion> iterator = criteria.getNomHistory().iterator(); iterator.hasNext();) {
				NOMHistoryOfAVersion type2 = (NOMHistoryOfAVersion) iterator.next();
				
				
				for (Iterator<NOMOfAClass> iterator2 = type2.getNomValues().iterator(); iterator2.hasNext();) {
	...
	public void deleteSmellRelevanceCriteria(SmellRelevanceCriteria type) {
		...
		try {
			transaction = session.beginTransaction();
			SmellRelevanceCriteria criteria = (SmellRelevanceCriteria) session.get(SmellRelevanceCriteria.class, type.getId());
	...
	public SmellRelevanceCriteria getSmellRelevanceCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<SmellRelevanceCriteria> list = session.createCriteria(SmellRelevanceCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public AgglomerationRelevanceCriteria getAgglomerationRelevanceCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<AgglomerationRelevanceCriteria> list = session.createCriteria(AgglomerationRelevanceCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		//Chequear que haya al menos un ret y armarlo bien
		if(list.size()>0){
			ret.setId(list.get(0).getId());
			ret.setRelevances(list.get(0).getRelevances());
	...
	public AgglomerationEvolutionCriteria getAgglomerationEvolutionCriteriaForProject(String projectName){
		...
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<AgglomerationEvolutionCriteria> list = session.createCriteria(AgglomerationEvolutionCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
		if(list.size()>0){
			ret.setId(list.get(0).getId());
	...
	public ModifiabilityScenariosForSmellsNormalizedCriteria getmodifiabilityScenariosForSmellsNormalizedCriteriaForProject(
			String projectName) {
		ModifiabilityScenariosForSmellsNormalizedCriteria ret=new ModifiabilityScenariosForSmellsNormalizedCriteria(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ModifiabilityScenariosForSmellsNormalizedCriteria> list = session.createCriteria(ModifiabilityScenariosForSmellsNormalizedCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
	...
	public ArchitecturalConcernCriteriaForSmellsNormalized getArchitecturalConcernCriteriaForSmellsNormalizedForProject(
			String projectName) {
		ArchitecturalConcernCriteriaForSmellsNormalized ret=new ArchitecturalConcernCriteriaForSmellsNormalized(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<ArchitecturalConcernCriteriaForSmellsNormalized> list = session.createCriteria(ArchitecturalConcernCriteriaForSmellsNormalized.class).add( Restrictions.eq("projectName", projectName) ).list();
	...
	public BlueprintCriteria getBlueprintCriteriaForSmellsNormalizedForProject(
			String projectName) {
		BlueprintCriteria ret=new BlueprintCriteria(projectName);
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<BlueprintCriteria> list = session.createCriteria(BlueprintCriteria.class).add( Restrictions.eq("projectName", projectName) ).list();
