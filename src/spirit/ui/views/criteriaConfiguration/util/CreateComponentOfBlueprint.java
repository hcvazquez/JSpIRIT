...
public class CreateComponentOfBlueprint extends Dialog {
	private ComponentOfBlueprintConfiguration architecturalProblemsConfiguration;
	private Text text;
	 ...
	 */
	public CreateComponentOfBlueprint(Shell parentShell,ComponentOfBlueprintConfiguration architecturalProblemsConfiguration, IProject currentProject) {
		super(parentShell);
	...
	protected void okButtonClicked() {
		architecturalProblemsConfiguration.addArchitecturalProblem(new ComponentOfBlueprint(getConcernName(), /*getComboSelectionKindOfProblem(comboViewerKindOfProblems),*/ selectedClasses, selectedPackages, currentProject.getFullPath().toString()));
